...
$(document).ready(() => {
	...
	chrome.runtime.sendMessage(
		{ researchyAction: "readFile", fileName: "static/html/reader.html" },
		(html) => {
			ANNOTATED_IFRAME.contents()
				.find("head")
				.html(
					html.replace(
						"{{utils/materialize/css/materialize.min.css}}",
	...
	chrome.runtime.sendMessage(
		{ researchyAction: "readFile", fileName: "static/html/spinner.html" },
		(html) => {
